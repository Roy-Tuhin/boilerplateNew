...
import 'package:applied_nurses/view/screens/navigation/bottom_navigation/bottom_navigation_view_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SmartRefresher(
        ...
        controller: ref
            .watch(bottomNavigationViewModelProvider)
            .bottomNavigationRefreshController,
        onRefresh: () async {},
